...
class Delivery_registration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Cityspin.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (cityy.equals("Mumbai")) {
                    ...
                    ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(Delivery_registration.this, android.R.layout.simple_spinner_item, listt);
        ...
        Emaill.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent a = new Intent(Delivery_registration.this, Delivery_Login.class);
                startActivity(a);
                finish();
            }
        });
