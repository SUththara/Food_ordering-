...
public class ChefhomeAdapter extends RecyclerView.Adapter<ChefhomeAdapter.ViewHolder> {
    ...
    private List<UpdateDishModal>updateDishModellist;

    public ChefhomeAdapter(Context context,List<UpdateDishModal>updateDishModellist)
    {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        final UpdateDishModal updateDishModel=updateDishModellist.get(position);
