...
public class CustomerHomeAdapter extends RecyclerView.Adapter<CustomerHomeAdapter.ViewHolder> {
    ...
    private List<UpdateDishModal>updateDishModalList;
    DatabaseReference databaseReference;

    public CustomerHomeAdapter(Context context,List<UpdateDishModal>updateDishModalList){
        this.updateDishModalList=updateDishModalList;
    ...
    public void onBindViewHolder(@NonNull CustomerHomeAdapter.ViewHolder holder, int position) {
        ...
        holder.Price.setText("Price:"+updateDishModal.getPrice()+"Rs");
    }

    @Override
    public int getItemCount() {
        return updateDishModalList.size();
    }
