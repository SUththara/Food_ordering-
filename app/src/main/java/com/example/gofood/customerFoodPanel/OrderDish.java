...
import com.example.gofood.Chef;
import com.example.gofood.chefFoodPanel.UpdateDishModal;
import com.example.gofood.Customer;
        ...
        dataaa.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        UpdateDishModal updateDishModel = dataSnapshot.getValue(UpdateDishModal.class);
                                ...
                                if (dataSnapshot.exists()) {
                                    ...
                                    if (ChefID.equals(cart1.getChefId())) {
                                        ...
                                        data.addListenerForSingleValueEvent(new ValueEventListener() {
                                            @Override
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                UpdateDishModal update = dataSnapshot.getValue(UpdateDishModal.class);
